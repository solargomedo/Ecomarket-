...
@Tag(name = "Usuario Controller", description = "Controlador para gestionar usuarios en Ecomarket.")
@RestController
...
public class UsuarioController {
    ...
    @PostMapping
    @Operation(summary = "Crear un nuevo usuario", description = "Hola, somos Victor, Jose y Sol y aca se guarda un nuevo usuario en el sistema.")
    public ResponseEntity<Usuario> guardar(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Detalles del usuario a crear", required = true) @RequestBody Usuario usuario) {
